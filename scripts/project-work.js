...
function renderArtifactForm() {
    ...
    form.innerHTML = `
        ...
        <p>Этот блок собирает часть вашего сквозного проекта: тему, цель, логику задания, выбранную механику и фидбек. Сохраненные ответы останутся в браузере на этом устройстве и автоматически попадут на страницу проекта, где из отдельных модулей складывается карта итогового интерактивного урока.</p>
