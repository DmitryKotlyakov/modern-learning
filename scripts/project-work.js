    ...
    form.innerHTML = `
        ...
        <div class="artifact-guide">
            ...
            <ol>
                ...
                <li><strong>Опишите финальные состояния.</strong> Зафиксируйте, чем заканчиваются основные маршруты: успешное решение, частичный успех, ошибка с возвратом или другой итог.</li>
